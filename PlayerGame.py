...
from FileWorker import load_dict_from_file, save_dict_to_file
...
class PlayerGame(object):
    ...
    def __init__(self):
        ...
        self.comp = Computer(load_dict_from_file("games2.txt"), self.game)
        self.comp_turn = 0
    ...
    def start(self):
        ...
        while True:
            ...
            data = load_dict_from_file("games2.txt")
            data[tuple(self.game)] = self.game.winner()
            save_dict_to_file(data, "games2.txt")
